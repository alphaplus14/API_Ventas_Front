        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <button class="btn btn-success mb-4" data-bs-toggle="modal" data-bs-target="#miModal" id="usuarioInsertar">➕ Insertar Producto</button>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" form="formularioProducto" class="btn btn-success">Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="tablaProductos" class="table table-striped table-hover table-bordered table-sm align-middle text-center">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Nombre</th>
            ...
            <!-- modal ver Producto-->
            <div class="modal fade" id="verProducto" name="miModal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formularioVerProducto">
                                <div class="mb-3">
                                    <label for="id" class="form-label">ID</label>
                                    <input type="text" class="form-control" id="verID" name="id" disabled>
                                </div>
                                <div class="mb-3">
                                    <label for="nombre" class="form-label">Nombre</label>
                                ...
                                <div class="mb-3">
                                    <label for="descripcion" class="form-label">Descripcion</label>
                                    <input type="text" class="form-control" id="verDescripcion" name="descripcion" disabled>
                                </div>

                                <div class="mb-3">
                                    <label for="precio" class="form-label">Precio</label>
                                    <input type="number" class="form-control" id="verPrecio" name="precio" disabled>
                                </div>
                                <div class="mb-3">
                                    <label for="Cantidad" class="form-label">Cantidad</label>
                                    <input type="number" class="form-control" id="verCantidad" name="Cantidad" disabled>
                                </div>
                            </form>
                        </div>
                        <div class="modal-footer">
        ...
        <div class="modal fade" id="modalEditar" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" form="formularioEditarProducto" class="btn btn-success">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
