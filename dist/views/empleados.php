...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <button class="btn btn-success mb-4" data-bs-toggle="modal" data-bs-target="#miModal" id="usuarioInsertar">➕ Crear Empleado</button>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" form="formularioEmpleado" class="btn btn-success">Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="tablaEmpleados" class="table table-striped table-hover table-bordered table-sm align-middle text-center">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Nombre</th>
            ...
            <!-- modal ver Empleado-->
            <div class="modal fade" id="verEmpleado" name="miModal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">

                        <div class="modal-header">
                            <h5 class="modal-title">Ver Empleado</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>

                        <div class="modal-body">
                            <form id="formularioVerEmpleado">

                                <div class="mb-3">
                                    <label for="id" class="form-label">Numero de Documento</label>
                                    <input type="text" class="form-control" id="verIdentificacion" name="identificacion" disabled>
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="telefono" class="form-label">Telefono</label>
                                    <input type="text" class="form-control" id="verTelefono" name="telefono" disabled>
                                </div>
                            </form>
                        </div>
                        <div class="modal-footer">
        ...
        <div class="modal fade" id="modalEditar" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" form="formularioEditarEmpleado" class="btn btn-success">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script src="../js/eliminarempleados.js"></script>
        <script src="../js/verempleado.js"></script>
